...
const phases = [
  ...
  },
  {
    ...
    prompts: [
      ...
      { text: 'run a Bell state on every qubit pair on Tuna-9. I want to know which connections actually work and how good they are.', note: 'Topology characterization: 10/36 pairs connected, 85.8-96.6% fidelity. Some "connected" pairs in docs were actually dead.' },
      ...
      { text: 'can we do Quantum Volume? run the standard QV protocol on Tuna-9 and see what we get.', note: 'QV=8 on Tuna-9 (3-qubit circuits pass). Compared to QV=32 on IBM and IQM.' },
  ...
  },
  {
    ...
    prompts: [
      ...
      { text: "we need the [[4,2,2]] code but each ancilla has to CNOT all 4 data qubits. Tuna-9's max degree is 3. this literally can't work.", note: 'Hardware connectivity constraint. Tuna-9 max degree=3, code needs degree=4. Shifted QEC work to IBM Torino (heavy-hex, plenty of connectivity).' },
