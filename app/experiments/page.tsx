...
export default function ExperimentsPage() {
  ...
  const groups = [
    ...
    { type: 'detection_code', label: '[[4,2,2]] Error Detection Code', results: detectionResults, color: '#a78bfa', description: 'Four data qubits with XXXX and ZZZZ stabilizers detect any single-qubit error (X, Z, or Y). A neural network decoder trained on hardware syndrome data outperforms simple lookup-table decoding -- Quantum Vibecoding in action.', wide: true },
